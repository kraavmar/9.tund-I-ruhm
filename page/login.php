...
<?php require("../header.php")?>
	...
	<div class="container"> <!-- Oleneb ekraanist, kuhu sisu jätab -->
	
		<div class="row">
		
			<div class="col-sm-4 col-sm-3"> <!-- Esimene väike, teine suur ekraan -->
			...
			<div class="col-sm-4 col-sm-3  col-sm-offset-4 col-sm-offset-3"><!-- offset- palju ruumi enne tulpa jääb -->
				...
				<form method="POST">
					...
					<input class="btn btn-success btn-sm" type="submit" value="Loo kasutaja"> <!-- class ja selle osad Bootstrapist -->
